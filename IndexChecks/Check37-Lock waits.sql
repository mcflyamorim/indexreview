...
SELECT TOP 1000
       ...
       CONVERT(VARCHAR(10), ((row_lock_wait_in_ms) / 1000) / 86400) + 'd:' + CONVERT(VARCHAR(20), DATEADD(s, ((row_lock_wait_in_ms) / 1000), 0), 108) AS total_avg_lock_duration_d_h_m_s,
       a.page_lock_count,
       ...
       CONVERT(VARCHAR(10), ((page_lock_wait_in_ms) / 1000) / 86400) + 'd:' + CONVERT(VARCHAR(20), DATEADD(s, ((page_lock_wait_in_ms) / 1000), 0), 108) AS total_page_lock_duration_d_h_m_s
